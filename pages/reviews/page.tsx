  ...
  return (
    <div className="min-h-screen bg-[#FCF8F1]">
      ...
      <main>
        ...
        <StandardCTA
          badge="Learner Outcomes"
            titlePrefix="Write Your"
            titleHighlight="Story Next"
            titleSuffix=""
            paragraph="Structured paths, real accountability and meaningful guidance make the difference in Qur'an, Arabic and studies progress."
            primaryLabel="Start Free Trial"
            points={[
              { icon: 'assessment', label: '92% consistency lift' },
              { icon: 'plan', label: 'Feedback-driven growth' },
              { icon: 'rating', label: '4.9/5 verified rating' }
            ]}
        />
      </main>
      <Footer />
